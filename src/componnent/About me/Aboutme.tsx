...
const Aboutme = () => {
    ...
    return (
        <div className="flex justify-center mb-10">
            <div className="bg-white rounded-lg shadow-md p-8 mx-4 w-80 md:w-96 lg:w-1/2 xl:w-1/3">
                {/* Add an image at the top */}
                <img 
                    src={"src/images/35e9789b-4ca9-4ef0-a7f8-69b71df8dd41.jfif"} // Use the imported image here
                    alt="Profile"
