    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center mb-10 gap-4">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-4">
                {/* Profile Card */}
                <div className="bg-white rounded-lg shadow-md p-8 w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                    <div className="mb-4">
                        <img
                            src="src/images/35e9789b-4ca9-4ef0-a7f8-69b71df8dd41.jfif" // Replace with your image path or URL
                            alt="Profile of Theekshana Shehal"
